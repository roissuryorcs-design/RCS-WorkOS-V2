...
// pattern most collaborative apps (including monday.com) use. Manage
// members/Invite used to live here too but moved out to their own header
// icons (💬 Board Discussion, 👥 Team) so they're reachable in one click
// instead of two.
